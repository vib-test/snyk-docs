...
See the [Git repository SCM integrations](../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/) pages for details about supported integrations.
