...
* A Git repository you have integrated with Snyk in the same way as for other Snyk products. For details, see [Git repository (SCM)](../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/).
