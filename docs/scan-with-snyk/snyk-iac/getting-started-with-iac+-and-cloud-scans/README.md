...
* Integration with your Git repository as for other Snyk products. For details, see [Git repositories (SCMs)](../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/).
