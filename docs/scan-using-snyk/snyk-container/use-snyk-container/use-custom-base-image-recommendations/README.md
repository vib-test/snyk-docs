...
{% hint style="info" %}
You can also do this using the Snyk REST API endpoint [Create a Custom Base Image from an existing container Project](https://apidocs.snyk.io/?#post-/custom_base_images).
{% endhint %}
