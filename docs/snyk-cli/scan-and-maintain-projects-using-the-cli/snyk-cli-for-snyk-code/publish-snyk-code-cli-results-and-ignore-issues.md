...
* A Git repository[ Integration](../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/) is not required.
...
* The results are saved as a new snapshot of the existing SCM Project, which requires a Git repository[ Integration](../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/).
...
* A Git repository[ Integration](../../../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/) is required, as the CLI command triggers a test using a Git repository Project.
