...
After your Git repository is connected (see [See Git repository integrations (SCMs)](../scm-ide-and-ci-cd-workflow-and-integrations/snyk-scm-integrations/) for details), you have automated processes available to automatically check pull requests for vulnerabilities, automatically generate pull requests, and automatically generate dependency upgrade pull requests. Snyk recommends you disable these options initially.
