...
<div align="left"><figure><img src="../../../.gitbook/assets/Screenshot 2023-05-02 at 15.39.28.png" alt="Organization geneal settings"><figcaption><p>Organization geneal settings</p></figcaption></figure></div>
...
* **Organization API key:** View or copy the Organization API key. [Service accounts](../../../enterprise-configuration/service-accounts/) require an API key (token) to substitute for standard user credentials. Click the **Manage Service accounts** button to set up details for service accounts.
