...
| Issue severity           | <ul><li>containing one or more of</li><li>containing all of</li><li>not containing one or more of</li><li>not containing all of</li></ul> | <ul><li>Critical</li><li>High</li><li>Medium</li><li>Low</li></ul>                                                   |
